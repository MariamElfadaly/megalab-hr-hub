          ...
          <>
            ...
            <div className="lg-previewWrap">
              <div className="lg-labelPreview">
                {previewUrl && <img src={previewUrl} alt="QR" />}
                <div className="lg-labelText">
                  <div className="lg-labelNameEn">{selected.nameEn}</div>
                  <div className="lg-labelNameAr">{selected.nameAr}</div>
                  <div className="lg-labelTitleEn">{selected.titleEn}</div>
                  <div className="lg-labelTitleAr">{selected.titleAr}</div>
                  <div className="lg-labelId">#{selected.id}</div>
                </div>
              </div>
              <p className="lg-previewHint">Actual size: 50mm × 25.4mm</p>
            </div>
